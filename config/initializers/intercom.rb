IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "k46svv3p"

  # == Intercom secret key 
  # This is reuqired to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "gdthB2u1VTL20tnP9WHbAbBNXkmoam0M_4Rf-mOG"
  ...
  #
  config.api_key = "9bb2e310998467fd63ad21ccfd4ae68721717270"
